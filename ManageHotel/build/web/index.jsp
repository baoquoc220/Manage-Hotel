...
<html lang="en">
  ...
  <body>
    ...
    <section class="ftco-section ftc-no-pb ftc-no-pt">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/bg_2.jpg); margin-top: 50px;">
        ...
        <div class="row d-flex">
            ...
            <div class="media block-6 services py-4 d-block text-center">
              <div class="d-flex justify-content-center">
              	<div class="icon d-flex align-items-center justify-content-center">
                    <i style="font-size: 50px" class="fa-solid fa-bell-concierge"></i>
              	</div>
              </div>
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services py-4 d-block text-center">
              <div class="d-flex justify-content-center">
              	<div class="icon d-flex align-items-center justify-content-center">
              		<i style="font-size: 50px" class="fa-solid fa-utensils"></i>
              	</div>
              </div>
              <div class="media-body p-2 mt-2">
          ...
          <div class="col-md-3 d-flex align-sel Searchf-stretch ftco-animate">
            <div class="media block-6 services py-4 d-block text-center">
              <div class="d-flex justify-content-center">
              	<div class="icon d-flex align-items-center justify-content-center">
              		<i style="font-size: 50px" class="fa-brands fa-servicestack"></i>
              	</div>
              </div>
              <div class="media-body p-2 mt-2">
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services py-4 d-block text-center">
              <div class="d-flex justify-content-center">
              	<div class="icon d-flex align-items-center justify-content-center">  
                        <i style="font-size: 50px" class="fa-sharp fa-solid fa-hot-tub-person"></i>
              	</div>
              </div>
              <div class="media-body p-2 mt-2">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
    		...
    		<div class="row">
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					<a href="rooms.jsp" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/room-1.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
                                                    <i style="font-size: 30px" class="fa-solid fa-magnifying-glass-plus"></i>
    						</div>
    					</a>
    					<div class="text p-3 text-center">
    						...
    						<hr>
                                                <p class="pt-1"><a href="room-single.jsp" class="btn-custom">View Room Details <i style="font-size: 15px" class="fa-light fa-right"></i></a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					<a href="rooms.jsp" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/room-2.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<i style="font-size: 30px" class="fa-solid fa-magnifying-glass-plus"></i>
    						</div>
    					</a>
    					<div class="text p-3 text-center">
    						...
    						<hr>
    						<p class="pt-1"><a href="room-single.jsp" class="btn-custom">View Room Details <i style="font-size: 15px" class="fa-light fa-right"></i></i></a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					<a href="rooms.jsp" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/room-3.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<i style="font-size: 30px" class="fa-solid fa-magnifying-glass-plus"></i>
    						</div>
    					</a>
    			...
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					<a href="rooms.jsp" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/room-4.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<i style="font-size: 30px" class="fa-solid fa-magnifying-glass-plus"></i>
    						</div>
    					</a>
    					<div class="text p-3 text-center">
    						<h3 class="mb-3"><a href="rooms.jsp">Classic Room</a></h3>
    			...
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					<a href="rooms.jsp" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/room-5.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<i style="font-size: 30px" class="fa-solid fa-magnifying-glass-plus"></i>
    						</div>
    					</a>
    			...
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					<a href="rooms.jsp" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/room-6.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<i style="font-size: 30px" class="fa-solid fa-magnifying-glass-plus"></i>
    						</div>
    					</a>
